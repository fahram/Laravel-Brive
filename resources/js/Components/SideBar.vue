...
<template>
    <div class="hidden lg:flex">
        <aside
            class="fixed lg:flex flex-col h-screen overflow-hidden w-64 bg-white dark:bg-gray-900 dark:border-r border-gray-100 dark:border-gray-800 dark:text-gray-300 ">
    ...
    <TransitionRoot :show="open">
        <Dialog as="div" @close="emit('close')" class="fixed inset-0 z-10 flex lg:hidden">
            <TransitionChild enter="transition ease-in-out duration-200 transform" enter-from="-translate-x-full"
                ...
                <aside class="flex flex-col relative z-10 w-64 bg-white dark:bg-gray-900 dark:border-r dark:border-gray-800">
