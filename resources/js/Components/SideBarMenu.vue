...
<template>
    <div class="text-gray-300 pt-5 pb-20">
        ...
        <div class="dark:text-white text-gray-600 text-center py-3 px-4 border-b border-gray-200 dark:border-gray-800">
        ...
        <ul class="space-y-2 my-4">
            <li class="bg-gray-50 dark:bg-gray-800/40 dark:text-white text-gray-600 rounded-sm hover:bg-primary dark:hover:bg-primary"
            ...
            <li v-show="can(['read user'])"
                class="bg-gray-50 dark:bg-gray-800/40 dark:text-white text-gray-600 rounded-sm hover:bg-primary dark:hover:bg-primary"
