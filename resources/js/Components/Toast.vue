<template>
    <transition name="slide-fade">
        <div v-if="flash.success && isVisible" class="absolute top-4 right-4 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
            <div class="flex p-4 justify-between items-center bg-green-600 rounded-md">
                <div>
                ...
                <button @click="toggle" type="button"
                    class="ml-auto bg-white/20 text-white rounded-md focus:ring-2 focus:ring-white/50 p-1.5 hover:bg-white/30 h-8 w-8">
    ...
    <transition name="slide-fade">
        <div v-if="flash.info && isVisible" class="absolute top-4 right-4 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
            <div class="flex p-4 justify-between items-center bg-primary rounded-md">
                <div>
    ...
    <transition name="slide-fade">
        <div v-if="flash.warning && isVisible" class="absolute top-4 right-4 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
            <div class="flex p-4 justify-between items-center bg-amber-600 rounded-md">
                <div>
    ...
    <transition name="slide-fade">
        <div v-if="flash.error && isErrorVisible" class="absolute top-4 right-4 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
            <div class="flex p-4 justify-between items-center bg-red-600 rounded-md">
                <div>
