...
<template>
    <nav
        class=" bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 text-gray-500 dark:text-gray-300">
                ...
                <div class="flex">
                    ...
                    <div class="mr-4 shrink-0 flex items-center lg:hidden">
                        <button v-on:click="emit('open')"
                            class="inline-flex items-center justify-center p-2 rounded-sm hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out">
